...
public class CommonUtil {
     ...
     *
     * @param date
     * @param pattern 为null时用默认格式转换(默认格式:yyyy-MM-dd HH:mm:ss)
     * @return
     */
     ...
     *
     * @param str
     * @param pattern 为null时用默认格式转换(默认格式:yyyy-MM-dd | yyyy-MM-dd HH:mm:ss)
     * @return
     * @throws ParseException 日期字符串格式错误时抛出此异常
     */
...
//			System.out.println("setter= " + setter + ",parameterTypes=" + type);
    ...
    public static Date startDate(String date) throws ParseException {
        Date newdDate = null;
        if (datetype(date)) {
            newdDate = new SimpleDateFormat("yyyy-MM-dd").parse(date);
            return newdDate;
        }
        newdDate = new SimpleDateFormat("yyyy-MM-dd").parse("1970-1-1");
        return newdDate;
    }

    public static Date endDate(String date) throws ParseException {
        Date newdDate = null;
        if (datetype(date)) {
            newdDate = new SimpleDateFormat("yyyy-MM-dd").parse(date);
            return newdDate;
     ...
     * @return
     */
    public static String blurType(String s){
